...
## Algorithm
1. Import the required libraries and load the dataset (Salary.csv). 2.Select the independent variable (Level) as feature X and the dependent variable (Salary) as target y.
...
plt.show()
new_exp=pd.DataFrame([[5]],columns=["Level"])
predicted_salary=model.predict(new_exp)
print("\nPredicted Salary for 5 years experience:",predicted_salary[0])
```

## Output:
<img width="935" height="743" alt="image" src="https://github.com/user-attachments/assets/9c990d5b-6bf6-4e1e-adef-41c1558ea6ac" />
